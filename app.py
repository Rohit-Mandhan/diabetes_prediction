...
rf_model = joblib.load(r"C:\Users\HP\Desktop\diabetes prediction\models\random_forest_model (2).pkl")
...
try:
    ann_model = tf.keras.models.load_model(r"C:\Users\HP\Desktop\diabetes prediction\models\ann_model (2).h5")
...
xgb_model.load_model(r"C:\Users\HP\Desktop\diabetes prediction\models\xgb_meta_model (2).json")
